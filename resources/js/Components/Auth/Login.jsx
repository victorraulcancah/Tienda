...
import { Eye, EyeOff, ShoppingBasket, AlertCircle, CheckCircle2, Truck, Percent, PackageCheck, LogOut } from 'lucide-react';
                    ...
                    <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 backdrop-blur-sm shadow-2xl shadow-black/40 p-8">
                        ...
                        {user ? (
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 rounded-lg border border-emerald-900/50 bg-emerald-950/40 p-4">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-zinc-50 text-sm font-medium truncate">{user.name}</p>
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 rounded-md border border-zinc-800 text-zinc-300 text-sm font-medium py-2.5 hover:bg-zinc-800/60 hover:text-zinc-100 transition-colors"
                                >
                                    <LogOut size={16} />
                                    Cerrar sesión
                                </button>
                                    ...
                                    <input
                                        ...
                                        className={`w-full rounded-md border bg-zinc-950 px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-600 outline-none focus:ring-2 transition-colors ${
                                            errors.email
                                                ...
                                                : 'border-zinc-800 focus:ring-zinc-100/20 focus:border-zinc-700'
                                        }`}
                                    />
                        ...
                        <p className="text-center text-xs text-zinc-600 mt-5">
                            Prueba con <span className="text-zinc-400">admin@tienda.com</span> /{' '}
